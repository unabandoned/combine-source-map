...
// Vendored from thlorenz/inline-source-map (MIT, same author and license as
// this package). combine-source-map is its only consumer and the upstream is
// abandoned, so it is inlined here to drop the dependency — and, with it, the
// stale `source-map@~0.5.3` that inline-source-map pinned. Built directly on
// source-map's synchronous SourceMapGenerator.
 ...
 * @param mappings {Array} each object has the form { original: { line: _, column: _ }, generated: { line: _, column: _ } }
 ...
 * @name base64Encode
 * @function
 * @return {String} base64 encoded representation of the added mappings
 */
